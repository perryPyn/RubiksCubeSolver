...
crossColor ={
                ...
                "d" : [(10,"d"),(12,"d"),(14,"d"),(15,"d"),(41,"d"),(23,"r"),(32,"l"),(46,"b")],
                "r" : [(19,"r"),(21,"r"),(23,"r"),(25,"r"),(39,"r"),(3 ,"u"),(12,"d"),(48,"b")],
                "l" : [(28,"l"),(30,"l"),(32,"l"),(34,"l"),(43,"l"),(7 ,"u"),(16,"d"),(52,"b")],
        ...
        for cubePre in cubesToTest:
            ...
            for move in moves :
                ...
                if [cube[1],cube[3],cube[5],cube[7],cube[28],cube[37],cube[19],cube[50],] == ["u","u","u","u","l","f","r","b"] and [cube[19],cube[28],cube[37],cube[50]] == ["r","l","f","b"]:
                    print("Cross sequence found after",attempts,"attempts :",sequence)# in",len(sequence),"moves"
                    cube = cube_o
                    return sequence
                if dictCubes.get(cube) == None:
                    dictCubes[cube] = sequence
                    cubesToTest.append(cube)
                elif len(dictCubes[cube]) > len(sequence) :
                    dictCubes[cube] = sequence
                attempts+=1
    ...
    while cubesToTest != []:
        for cubePre in cubesToTest:
            ...
            for move in moves :
                ...
                sequence = dictCubes[cubePre] + move
                correctCross = True
                for face in colors: # Pour chaque face du cube
                    for edge,faceColor in crossColor[face]: # On regarde l'arrête et la couleur de la face associée
                        if faceColor != cube[edge]: # La couleur de l'arrête ,n'est la même que la face sur laquelle est est ?
                            correctCross == False # Alors la croix n'est pas viable
                            break # Pas besoin de check la suite, on passe à une autre face
                    if correctCross == False :
                        break

                        print("Cross sequence found after",len(dictCubes),"attempts :",sequence)# in",len(sequence),"moves"
                        cube = cube_o
                        return sequence
                    if dictCubes.get(cube) == None:
                        dictCubes[cube] = sequence
...
startTime =time()
sequenceCroix = SearchForWCross(scramble)
print("fin recherche :",time()-startTime)
Sequence(scramble)
